...
const PresentationHero = () => {
  return (
    <div
      id="ParentHolder"
      className="grid grid-cols-5 w-full px-[6rem] bg-cover bg-center py-20 font-inter"
      style={{ backgroundImage: "url(/images/bgTexture.jpg)" }}
    >
      <div id="TitleAndButtons" className="col-span-2 mt-10">
        <p className="text-[4rem] leading-snug  tracking-wide  font-bold">
        ...
        <div
          id="buttons"
          className="flex items-center text-xl  font-bold my-14"
        >
          <Link to="/contact">
      ...
      >
        <img className="rounded-full w-[28rem]" src="/images/CleanCode.jpg" />
      </div>
    </div>
  );
};
