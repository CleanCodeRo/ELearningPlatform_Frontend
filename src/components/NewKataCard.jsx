...
export default function NewKataCard(key){
    ...
    return (
        <div id="cardHolder" className=" w-64 h-fit bg-[#fceeca] flex flex-col items-center border-2 border-[#aa6b48] rounded-2xl font-ninja" >
            <p id="title" className="text-[#0b0f1b] mt-2 font-ninja">Kata Name</p>
...
{[...Array(8)].map((_, index) => (
                    <Stars key={index} color={index < kataKyu ? '#e98735' : '#806A5F'} />
                ))}
</div>
            ...
            <div id="Details"  className="text-[#0b0f1b] flex !flex-row">
                ...
                <p id="pointsPerCompetion" className="ml-1 mt-1">Rank: +30</p>
            ...
            <button id="beginTraining" className="text-[#0b0f1b]  border border-[#aa6b48] rounded-full w-24 " >Train</button>
            </div>
