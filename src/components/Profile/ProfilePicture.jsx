...
export default function ProfilePicture({ uploadPhoto, imageRef }) {
    return (
            <label onClick={uploadPhoto} id="pfpImage" className="w-[200px] h-[200px] bg-white rounded-full flex justify-center items-center relative group">
                ...
                <img ref={imageRef} className="w-full h-full rounded-full absolute z-10" />
            </label>
    )
}
