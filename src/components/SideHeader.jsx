...
export default function SideHeader() {
  ...
  const MenuIcon = ({ pathChildren, iconEvent, toolTipContent, iconClassName }) => {
    return (
    ...
    >
      ...
      <div id="logoAndHamburgerMenu" className=" ml-7 md:ml-0 mt-0 md:mt-7 flex items-center z-20">
        ...
        <SpeedDial placement="right">
          <SpeedDialHandler>
            <i className="fa-solid fa-bars flex sm:hidden text-white text-2xl mr-2 "></i>
          </SpeedDialHandler>
          <SpeedDialContent className=" flex-row w-full h-full backdrop-blur-sm gap-3">
            ...
            <SpeedDialAction >
              <MenuIcon pathChildren={
                ...
                iconClassName="`flex items-center justify-center rounded-full w-[40px] h-[40px] sm:w-[50px] sm:h-[50px] cursor-pointer fill-black `">
              </MenuIcon>
            </SpeedDialAction>
            <SpeedDialAction>
              <MenuIcon pathChildren={
            ...
            <SpeedDialAction>
            <MenuIcon pathChildren={
             <img draggable={false} className="w-[1.6rem]" src="/SVGs/statusSVGs/closed.svg" style={{filter: "invert(100%)"}}></img>
              }
      ...
      <div id="iconsHolder" className="hidden sm:flex flex-row md:flex-col  gap-3 xs:gap-5 md:!gap-0 z-10">
        <MenuIcon pathChildren={
          ...
          toolTipContent={"Courses"}
          iconEvent={() => navigate("/home")}
          iconClassName="`flex items-center justify-center rounded-full w-[40px] h-[40px] sm:w-[50px] sm:h-[50px]  mb-4 mt-7  cursor-pointer fill-white hover:fill-generalColors-medium-blue`">
        </MenuIcon>
        ...
        {user?.role == "ADMIN" &&
          <MenuIcon pathChildren={
            ...
            toolTipContent={"Permisions"}
            iconEvent={() => navigate("/permissions")}
            iconClassName=" flex items-center justify-center rounded-full w-[40px] h-[40px] sm:w-[50px] sm:h-[50px]  mb-4 mt-7  cursor-pointer fill-white "
          >
      ...
      <Avatar
        ...
        src={user?.profileImageUrl ? user?.profileImageUrl : "/images/noprofilepicture.png"}
      />
    </div>
  );
}
